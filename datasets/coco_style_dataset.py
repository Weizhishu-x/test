...
class CocoStyleDataset(CocoDetection):
    ...
    img_dirs = {
        'xView': {
            'train': '/home/wzs/Projects/data/xView2DOTA/xView/images',
        },
        'DOTA': {
            'train': '/home/wzs/Projects/data/xView2DOTA/DOTA/train/images', 
            'val': '/home/wzs/Projects/data/xView2DOTA/DOTA/val/images',
        },
        'HRRSD': {
        ...
        'CARPK':{
            'train': '/input2/CARPK/train/images',
            'val': '/input2/CARPK/test/images',
        },
        'UCASAOD':{
            'train': '/input2/UCAS-AOD/train/images',
            'val': '/input2/UCAS-AOD/test/images',
        },
    }
    anno_files = {
        'xView': {
            'source': {
                'train': '/home/wzs/Projects/data/xView2DOTA/xView/annotations/train_3c.json',
            },
        },
        'DOTA': {
            'target': {
                'train': '/home/wzs/Projects/data/xView2DOTA/DOTA/annotations/train_3c.json',
                'val': '/home/wzs/Projects/data/xView2DOTA/DOTA/annotations/val_3c.json',
            }
        },
        'HRRSD': {
            'source': {
        ...
        'CARPK': {
            'source': {
                'train': '/input2/CARPK/train/annotations.json',
                'val': '/input2/CARPK/test/annotations.json',
            },
            'target': {
                'train': '/input2/CARPK/train/annotations.json',
                'val': '/input2/CARPK/test/annotations.json',
        ...
        'UCASAOD': {
            'source': {
                'train': '/input2/UCAS-AOD/train/annotations.json',
                'val': '/input2/UCAS-AOD/test/annotations.json',
            },
            'target': {
                'train': '/input2/UCAS-AOD/train/annotations.json',
                'val': '/input2/UCAS-AOD/test/annotations.json',
